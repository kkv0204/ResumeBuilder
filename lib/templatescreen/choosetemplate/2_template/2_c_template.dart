...
class ResumeClassicPage2 extends StatefulWidget {
  const ResumeClassicPage2({Key? key}) : super(key: key);

  @override
  State<ResumeClassicPage2> createState() => _ResumeClassicPage2State();
}

class _ResumeClassicPage2State extends State<ResumeClassicPage2> with SingleTickerProviderStateMixin {
  ...
  getData() async {
    ...
    //allHobbies!=null?data.add(jsonDecode(allHobbies)):data.add("empty");
...
const examples = [
  Example('Resume', 'resume.dart',templateClassic2 ),
];
